...
const PROFILES = Object.freeze({
  ...
  coding: {
    ...
    requiredCapabilities: { code: true },
    categoryBoosts: { code: 0.12, architecture: 0.08, security: 0.04 },
  },
  legal: {
    title: 'Legal',
    policy: 'best',
    ...
    categoryBoosts: { legal: 0.2, 'high-stakes': 0.12, research: 0.06 },
  },
  research: {
    title: 'Research',
    policy: 'best',
    minimumTier: 'balanced',
    requiredCapabilities: { web: true },
    categoryBoosts: { research: 0.18, sources: 0.1 },
  },
  creative: {
    title: 'Creative',
    policy: 'balanced',
    minimumTier: 'balanced',
    requiredCapabilities: {},
    categoryBoosts: { creative: 0.16, writing: 0.08 },
  },
  security: {
    title: 'Security',
    policy: 'best',
    minimumTier: 'deep',
    requiredCapabilities: { code: true },
    categoryBoosts: { security: 0.22, code: 0.08, 'high-stakes': 0.12 },
  },
  finance: {
    title: 'Finance',
    policy: 'best',
    minimumTier: 'deep',
    requiredCapabilities: {},
    categoryBoosts: { finance: 0.2, 'high-stakes': 0.12, analysis: 0.06 },
  },
  medical: {
    title: 'Medical',
    policy: 'best',
    minimumTier: 'deep',
    requiredCapabilities: {},
    categoryBoosts: { medical: 0.2, 'high-stakes': 0.14, research: 0.06 },
  },
