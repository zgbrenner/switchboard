...
const PATTERNS = {
  ...
  plan: /\b(implementation plan|architecture|design a system|roadmap|spec(?:ification)?|step[- ]by[- ]step)\b/i,
  code: /```|\b(debug|stack trace|exception|typescript|javascript|python|rust|react|api|sql|regex|function|class|repository|pull request)\b/i,
