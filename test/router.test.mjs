...
test('routes deep verified research to max and requires web', () => {
  const decision = routeRequest({
    ...base,
    prompt: 'Research this deeply, verify every claim with current primary sources, compare the competing approaches, and produce a detailed implementation plan.'
  });
